...
function RunTest {
    ...
    switch ($test)
    {
        ...
        15 {
            ...
            New-Pptx OxPtTemp-Input1.pptx -AdjacencyTheme -FiveSlides -LoadAndSaveUsingPowerPoint
            Write-Verbose "Creating and testing OxPtTemp-Input2.pptx"
            New-Pptx OxPtTemp-Input2.pptx -BlankLayout -ComparisonLayout -TenSlides -LoadAndSaveUsingPowerPoint
            $pres1 = New-Object OpenXmlPowerTools.SlideSource("OxPtTemp-Input1.pptx", $true)
            $pres2 = New-Object OpenXmlPowerTools.SlideSource("OxPtTemp-Input2.pptx", $true)
            $sources = ($pres1, $pres2)
